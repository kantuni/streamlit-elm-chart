...
{
	if (region.aJ.cb === region.aZ.cb)
	{
		return 'on line ' + region.aJ.cb;
	}
	return 'on lines ' + region.aJ.cb + ' through ' + region.aZ.cb;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b$: 'hidden', bR: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b$: 'mozHidden', bR: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b$: 'msHidden', bR: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b$: 'webkitHidden', bR: 'webkitvisibilitychange' }
		: { b$: 'hidden', bR: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a1: fragment, a3: host, bi: path, bk: port_, bo: protocol, bp: query};
	});
...
var $author$project$Main$Received = $elm$core$Basics$identity;
...
var $terezka$line_charts$Internal$Axis$Intersection$at = F2(
	function (x, y) {
		return A2(
			$terezka$line_charts$Internal$Axis$Intersection$custom,
			$elm$core$Basics$always(x),
			$elm$core$Basics$always(y));
	});
var $terezka$line_charts$LineChart$Axis$Intersection$at = $terezka$line_charts$Internal$Axis$Intersection$at;
var $terezka$line_charts$LineChart$Container$Margin = F4(
	function (top, right, bottom, left) {
		return {bQ: bottom, bb: left, ck: right, bD: top};
	});
...
var $author$project$Main$containerConfig = $terezka$line_charts$LineChart$Container$custom(
	{
		bN: _List_fromArray(
			[
		...
		bO: _List_Nil,
		b0: 'streamlit',
		cc: A4($terezka$line_charts$LineChart$Container$Margin, 60, 140, 60, 80),
		cl: $terezka$line_charts$LineChart$Container$relative
	});
...
var $terezka$line_charts$Internal$Axis$Title$atDataMax = function () {
	var position = F2(
		function (data, range) {
			return A2($elm$core$Basics$min, data.S, range.S);
		});
...
var $terezka$line_charts$Internal$Axis$Values$values = F4(
	function (allowDecimals, exact, amountRough, range) {
		var intervalRough = (range.S - range.T) / amountRough;
		var interval = A3($terezka$line_charts$Internal$Axis$Values$getInterval, intervalRough, allowDecimals, exact);
		var intervalSafe = (!interval) ? 1 : interval;
		var beginning = A2($terezka$line_charts$Internal$Axis$Values$getBeginning, range.T, intervalSafe);
...
var $terezka$line_charts$Internal$Axis$Tick$float = function (n) {
	return $terezka$line_charts$Internal$Axis$Tick$custom(
		{
			_: $terezka$line_charts$LineChart$Colors$gray,
			ab: 0,
			bZ: true,
...
var $terezka$line_charts$Internal$Coordinate$smallestRange = F2(
	function (data, range_) {
		return {
			S: A2($elm$core$Basics$min, data.S, range_.S),
			T: A2($elm$core$Basics$max, data.T, range_.T)
		};
	});
	...
	return $terezka$line_charts$Internal$Axis$Line$custom(
		F2(
			function (data, range) {
				...
				return {_: color, aZ: smallest.S, bX: _List_Nil, aJ: smallest.T, bI: 1};
			}));
};
var $terezka$line_charts$Internal$Axis$default = F3(
	function (pixels_, title_, variable_) {
		return $terezka$line_charts$Internal$Axis$custom(
			{
				t: $terezka$line_charts$Internal$Axis$Line$rangeFrame($terezka$line_charts$LineChart$Colors$gray),
				A: pixels_,
				B: A2($terezka$line_charts$Internal$Axis$Range$padded, 20, 20),
				j: $terezka$line_charts$Internal$Axis$Ticks$custom(
					F2(
						function (data, range_) {
							var smallest = A2($terezka$line_charts$Internal$Coordinate$smallestRange, data, range_);
							var rangeSmall = smallest.S - smallest.T;
							var rangeLong = range_.S - range_.T;
				...
				co: A3($terezka$line_charts$Internal$Axis$Title$atDataMax, 0, 0, title_),
				D: A2($elm$core$Basics$composeL, $elm$core$Maybe$Just, variable_)
			});
	});
...
var $terezka$line_charts$Internal$Junk$Layers = F3(
	function (below, above, html) {
		return {Y: above, M: below, ae: html};
	});
...
var $terezka$line_charts$Internal$Coordinate$lengthX = function (system) {
	return A2($elm$core$Basics$max, 1, (system.R.cl.bI - system.R.cc.bb) - system.R.cc.ck);
};
var $terezka$line_charts$Internal$Coordinate$reachX = function (system) {
	var diff = system.W.S - system.W.T;
...
var $terezka$line_charts$LineChart$Coordinate$toSvgX = F2(
	function (system, value) {
		return A2($terezka$line_charts$LineChart$Coordinate$scaleSvgX, system, value - system.W.T) + system.R.cc.bb;
	});
var $terezka$line_charts$Internal$Coordinate$lengthY = function (system) {
	return A2($elm$core$Basics$max, 1, (system.R.cl.a2 - system.R.cc.bQ) - system.R.cc.bD);
};
var $terezka$line_charts$Internal$Coordinate$reachY = function (system) {
	var diff = system.X.S - system.X.T;
	return (diff > 0) ? diff : 1;
};
...
var $terezka$line_charts$LineChart$Coordinate$toSvgY = F2(
	function (system, value) {
		return A2($terezka$line_charts$LineChart$Coordinate$scaleSvgY, system, system.X.S - value) + system.R.cc.bD;
	});
...
var $author$project$Main$chartConfig = {
	bL: $terezka$line_charts$LineChart$Area$normal(0.75),
	bS: $author$project$Main$containerConfig,
	bU: $terezka$line_charts$LineChart$Dots$custom(
		A2($terezka$line_charts$LineChart$Dots$empty, 5, 1)),
	bX: $terezka$line_charts$LineChart$Events$default,
	bZ: $terezka$line_charts$LineChart$Grid$default,
	b3: $terezka$line_charts$LineChart$Interpolation$monotone,
	b4: A2($terezka$line_charts$LineChart$Axis$Intersection$at, 1961, 0),
	b9: $terezka$line_charts$LineChart$Junk$default,
	ca: $terezka$line_charts$LineChart$Legends$default,
	cb: $terezka$line_charts$LineChart$Line$default,
	W: A3(
...
var $terezka$line_charts$Internal$Line$SeriesConfig = F5(
	function (color, shape, dashing, label, data) {
		return {_: color, aV: dashing, x: data, ba: label, by: shape};
	});
...
var $author$project$Main$lineCharts = function (stats) {
	var _v0 = stats._;
	var r = _v0.a;
	var g = _v0.b;
	var b = _v0.c;
	var color = A3($avh4$elm_color$Color$rgb255, r, g, b);
	return A4($terezka$line_charts$LineChart$line, color, $terezka$line_charts$LineChart$Dots$none, stats.ay, stats.x);
};
...
var $terezka$line_charts$LineChart$chartAreaAttributes = function (system) {
	return _List_fromArray(
		[
			...
			$elm$core$String$fromFloat(system.R.cc.bb)),
			$elm$svg$Svg$Attributes$y(
			$elm$core$String$fromFloat(system.R.cc.bD)),
		...
		var attributes = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					A3($terezka$line_charts$Internal$Events$toChartAttributes, data, system, config.bX)
				]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$terezka$line_charts$Internal$Utils$toChartAreaId(system.b0))
			]),
		_List_fromArray(
			[
				A2(
...
var $terezka$line_charts$LineChart$container = F4(
	function (config, _v0, junkHtml, plot) {
		...
		var userAttributes = A2(
			...
			config.bS);
		var sizeStyles = A3($terezka$line_charts$Internal$Container$sizeStyles, config.bS, frame.cl.bI, frame.cl.a2);
		var styles = A2(
			$elm$core$List$cons,
...
var $terezka$line_charts$Internal$Data$Data = F3(
	function (user, point, isReal) {
		return {b8: isReal, ci: point, cv: user};
	});
var $terezka$line_charts$LineChart$setY = F2(
	function (datum, y) {
		return A3(
			...
			datum.cv,
			A2($terezka$line_charts$Internal$Data$Point, datum.ci.W, y),
			datum.b8);
	});
	...
	if (datasets.b) {
		...
		var toPercentage = F2(
			function (highest_, datum) {
				return A2($terezka$line_charts$LineChart$setY, datum, (100 * datum.ci.X) / highest_.ci.X);
			});
		return A2(
			$elm$core$List$map,
	...
	function (alldata, dataBelowAll) {
		var add = F2(
			function (below, datum) {
				return A2($terezka$line_charts$LineChart$setY, below, below.ci.X + datum.ci.X);
			});
		var iterate = F4(
				...
				while (true) {
					...
					if (_v0.a.b) {
						if (_v0.b.b) {
							...
							var dataBelow = _v2.b;
							if (_Utils_cmp(datum1.ci.W, datumBelow.ci.W) > 0) {
								if (datumBelow.b8) {
						...
						if (_v0.b.b) {
							...
							var dataBelow = _v3.b;
							if (_Utils_cmp(datum0.ci.W, datumBelow.ci.W) < 1) {
								var $temp$datum0 = datum0,
...
var $terezka$line_charts$LineChart$toDataPoints = F2(
	function (config, lines) {
		var y = $terezka$line_charts$Internal$Axis$variable(config.X);
		var x = $terezka$line_charts$Internal$Axis$variable(config.W);
		...
		switch (range.$) {
			case 0:
						...
						R: _Utils_update(
							frame,
							{
								cl: _Utils_update(
									size,
									{
										bI: A2($elm$core$Basics$max, 1, (size.bI - padMin) - padMax)
									})
							})
					});
				...
				return A2(
					...
					system.W.T - scale(padMin),
					system.W.S + scale(padMax));
			case 1:
				var min = range.a;
				var max = range.b;
	...
	function (range, system) {
		switch (range.$) {
			case 0:
						...
						R: _Utils_update(
							frame,
							{
								cl: _Utils_update(
									size,
									{
										a2: A2($elm$core$Basics$max, 1, (size.a2 - padMin) - padMax)
									})
							})
					});
				...
				return A2(
					$terezka$line_charts$LineChart$Coordinate$Range,
					system.X.T - scale(padMin),
					system.X.S + scale(padMax));
			case 1:
				var min = range.a;
				var max = range.b;
				return A2($terezka$line_charts$LineChart$Coordinate$Range, min, max);
...
var $terezka$line_charts$Internal$Coordinate$ground = function (range_) {
	return _Utils_update(
		range_,
		{
			T: A2($elm$core$Basics$min, range_.T, 0)
		});
};
...
var $terezka$line_charts$Internal$Coordinate$range = F2(
	function (toValue, data) {
		var range_ = {
			S: A2($terezka$line_charts$Internal$Coordinate$maximum, toValue, data),
			T: A2($terezka$line_charts$Internal$Coordinate$minimum, toValue, data)
		};
		return _Utils_eq(range_.T, range_.S) ? _Utils_update(
			range_,
			{S: range_.S + 1}) : range_;
	});
var $terezka$line_charts$LineChart$toSystem = F2(
	function (config, data) {
		...
		var size = A2(
			...
			$terezka$line_charts$Internal$Axis$pixels(config.W),
			$terezka$line_charts$Internal$Axis$pixels(config.X));
		var hasArea = $terezka$line_charts$Internal$Area$hasArea(config.bL);
		var container_ = A2($terezka$line_charts$Internal$Container$properties, $elm$core$Basics$identity, config.bS);
		var frame = A2($terezka$line_charts$Internal$Coordinate$Frame, container_.cc, size);
		...
		return _Utils_update(
			system,
			{
				W: A2(
					...
					$terezka$line_charts$Internal$Axis$range(config.W),
					system),
				X: A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(point.W)),
...
var $terezka$line_charts$LineChart$Coordinate$toSvg = F2(
	function (system, point) {
		return {
			W: A2($terezka$line_charts$LineChart$Coordinate$toSvgX, system, point.W),
			X: A2($terezka$line_charts$LineChart$Coordinate$toSvgY, system, point.X)
		};
	});
...
var $terezka$line_charts$Internal$Path$point = function (point_) {
	return $elm$core$String$fromFloat(point_.W) + (' ' + $elm$core$String$fromFloat(point_.X));
};
...
var $terezka$line_charts$Internal$Svg$horizontalGrid = F3(
	function (system, userAttributes, y) {
		var attributes = A3(
			...
			userAttributes,
			_List_Nil);
		return A5($terezka$line_charts$Internal$Svg$horizontal, system, attributes, y, system.W.T, system.W.S);
	});
...
var $terezka$line_charts$Internal$Svg$verticalGrid = F3(
	function (system, userAttributes, x) {
		var attributes = A3(
			...
			userAttributes,
			_List_Nil);
		return A5($terezka$line_charts$Internal$Svg$vertical, system, attributes, x, system.X.T, system.X.S);
	});
...
var $terezka$line_charts$Internal$Grid$view = F4(
	function (system, xAxis, yAxis, grid) {
		var hasGrid = function (tick) {
			return tick.bZ ? $elm$core$Maybe$Just(tick.V) : $elm$core$Maybe$Nothing;
		};
		var horizontals = A2(
...
var $terezka$line_charts$LineChart$Coordinate$toDataX = F2(
	function (system, value) {
		return system.W.T + A2($terezka$line_charts$LineChart$Coordinate$scaleDataX, system, value - system.R.cc.bb);
	});
var $terezka$line_charts$LineChart$Coordinate$toDataY = F2(
	function (system, value) {
		return system.X.S - A2($terezka$line_charts$LineChart$Coordinate$scaleDataY, system, value - system.R.cc.bD);
	});
var $terezka$line_charts$LineChart$Coordinate$toData = F2(
	function (system, point) {
		return {
			W: A2($terezka$line_charts$LineChart$Coordinate$toDataX, system, point.W),
			X: A2($terezka$line_charts$LineChart$Coordinate$toDataY, system, point.X)
		};
	});
...
var $terezka$line_charts$Internal$Dots$pathPlus = F2(
	function (area, point) {
		...
		var commands = _List_fromArray(
			[
				'M' + ($elm$core$String$fromFloat(point.W - r6) + (' ' + $elm$core$String$fromFloat((point.X - r3) - r6))),
...
var $terezka$line_charts$Internal$Dots$viewCross = F5(
	function (events, variety, color, area, point) {
		var rotation = 'rotate(45 ' + ($elm$core$String$fromFloat(point.W) + (' ' + ($elm$core$String$fromFloat(point.X) + ')')));
		var attributes = _List_fromArray(
			[
				$elm$svg$Svg$Attributes$d(
...
var $terezka$line_charts$Internal$Dots$viewDiamond = F5(
	function (events, variety, color, area, point) {
		...
		var attributes = _List_fromArray(
			[
				$elm$svg$Svg$Attributes$x(
				$elm$core$String$fromFloat(point.W - (side / 2))),
				$elm$svg$Svg$Attributes$y(
...
var $terezka$line_charts$Internal$Dots$pathTriangle = F2(
	function (area, point) {
		...
		var commands = _List_fromArray(
			[
				'M' + ($elm$core$String$fromFloat(point.W) + (' ' + $elm$core$String$fromFloat(point.X - fromMiddle))),
		...
		return _List_fromArray(
			[
				...
				$avh4$elm_color$Color$toCssString(
					style_._(serie._))),
				$elm$svg$Svg$Attributes$strokeWidth(
				$elm$core$String$fromFloat(style_.bI)),
				$elm$svg$Svg$Attributes$strokeDasharray(
				A2(
					$elm$core$String$join,
					' ',
					A2($elm$core$List$map, $elm$core$String$fromFloat, serie.aV))),
				$elm$svg$Svg$Attributes$fill('transparent')
			]);
	});
...
var $terezka$line_charts$Internal$Legends$viewSample = F4(
	function (_v0, sampleWidth, line, data) {
		var system = _v0.bB;
		var lineConfig = _v0.bd;
		var dotsConfig = _v0.aY;
		var area = _v0.bL;
...
var $terezka$line_charts$Internal$Legends$viewGrouped = F3(
	function (_arguments, sampleWidth, container) {
		var toLegend = F2(
			function (line, data) {
				return {
					ba: $terezka$line_charts$Internal$Line$label(line),
					aA: A4($terezka$line_charts$Internal$Legends$viewSample, _arguments, sampleWidth, line, data)
				};
			});
		var legends = A3($elm$core$List$map2, toLegend, _arguments.ao, _arguments.x);
		return A2(container, _arguments.bB, legends);
	});
var $terezka$line_charts$Internal$Legends$view = function (_arguments) {
	var _v0 = _arguments.ca;
	switch (_v0.$) {
		case 1:
			var placement = _v0.a;
			var view_ = _v0.b;
...
var $terezka$line_charts$Internal$Data$isWithinRange = F2(
	function (system, point) {
		return _Utils_eq(
			A3($elm$core$Basics$clamp, system.W.T, system.W.S, point.W),
			point.W) && _Utils_eq(
			A3($elm$core$Basics$clamp, system.X.T, system.X.S, point.X),
			point.X);
	});
...
var $terezka$line_charts$Internal$Interpolation$monotoneCurve = F4(
	function (point0, point1, tangent0, tangent1) {
		var dx = (point1.W - point0.W) / 3;
		return A3(
			$terezka$line_charts$Internal$Path$CubicBeziers,
			{W: point0.W + dx, X: point0.X + (dx * tangent0)},
			{W: point1.W - dx, X: point1.X - (dx * tangent1)},
			point1);
	});
var $terezka$line_charts$Internal$Interpolation$slope2 = F3(
	function (point0, point1, t) {
		var h = point1.W - point0.W;
		return (!(!h)) ? ((((3 * (point1.X - point0.X)) / h) - t) / 2) : t;
	});
...
var $terezka$line_charts$Internal$Interpolation$after = F2(
	function (a, b) {
		return _List_fromArray(
			[
				a,
				A2($terezka$line_charts$Internal$Data$Point, b.W, a.X),
				b
			]);
	});
					...
					if (section.a.b.b) {
						...
						if (!section.b.$) {
							...
							return _Utils_ap(
								...
								_List_fromArray(
									[
										A2($terezka$line_charts$Internal$Data$Point, broken.W, last.X)
									]));
						} else {
							var _v4 = section.a;
							var last = _v4.a;
	...
	function (_v0, line_, style_, interpolation, data_) {
		...
		var ground = function (point) {
			return A2(
				$terezka$line_charts$Internal$Data$Point,
				point.W,
				$terezka$line_charts$Internal$Utils$towardsZero(system.X));
		};
		var commands = F3(
...
var $terezka$line_charts$Internal$Dots$view = F2(
	function (_v0, data) {
		...
		var _v1 = dotsConfig;
		var config = _v1;
		var _v2 = config.al(data.cv);
		var style_ = _v2;
		return A5($terezka$line_charts$Internal$Dots$viewShape, system, style_, shape, color, data.ci);
	});
			...
			F2(
				function (first, _v1) {
					return A3(
						...
						A2(
							$elm$core$List$cons,
							$terezka$line_charts$Internal$Path$Move(first.ci),
							interpolation));
				}));
	});
var $terezka$line_charts$Internal$Line$viewSingle = F3(
	function (_arguments, line_, data_) {
		...
		var viewDots = A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeL,
						$terezka$line_charts$Internal$Data$isWithinRange(_arguments.bB),
						function ($) {
							return $.ci;
						}),
					$elm$core$List$concat(parts))));
		var commands = A2($terezka$line_charts$Internal$Interpolation$toCommands, _arguments.b3, sections);
		...
		return _Utils_Tuple3(
			A2(
				$terezka$line_charts$Internal$Utils$viewIf,
				$terezka$line_charts$Internal$Area$hasArea(_arguments.bL),
				viewAreas),
			viewSeriess,
			viewDots);
	});
...
var $terezka$line_charts$Internal$Line$view = F3(
	function (_arguments, lines, datas) {
		...
		var buildSeriesViews = ($terezka$line_charts$Internal$Area$opacityContainer(_arguments.bL) < 1) ? $terezka$line_charts$Internal$Line$viewStacked(_arguments.bL) : $terezka$line_charts$Internal$Line$viewNormal;
		return container(
			buildSeriesViews(
...
var $terezka$line_charts$LineChart$viewBoxAttribute = function (_v0) {
	...
	return $elm$svg$Svg$Attributes$viewBox(
		'0 0 ' + ($elm$core$String$fromFloat(frame.cl.bI) + (' ' + $elm$core$String$fromFloat(frame.cl.a2))));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($terezka$line_charts$Internal$Svg$move, system, position.W, position.X),
...
var $terezka$line_charts$Internal$Axis$viewHorizontal = F3(
	function (system, intersection, _v0) {
		var config = _v0;
		var viewConfig = {
			b4: A2($terezka$line_charts$Internal$Axis$Intersection$getY, intersection, system),
			cb: A3($terezka$line_charts$Internal$Axis$Line$config, config.t, system.aO, system.W),
			j: A3($terezka$line_charts$Internal$Axis$Ticks$ticks, system.aO, system.W, config.j),
			co: $terezka$line_charts$Internal$Axis$Title$config(config.co)
		};
		var viewAxisLine = A2($terezka$line_charts$Internal$Axis$viewHorizontalAxisLine, system, viewConfig.b4);
		var at = function (x) {
			return {W: x, X: viewConfig.b4};
		};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$core$List$map, viewTick, viewConfig.j))
				]));
	});
...
var $terezka$line_charts$Internal$Axis$viewVertical = F3(
	function (system, intersection, _v0) {
		var config = _v0;
		var viewConfig = {
			b4: A2($terezka$line_charts$Internal$Axis$Intersection$getX, intersection, system),
			cb: A3($terezka$line_charts$Internal$Axis$Line$config, config.t, system.aP, system.X),
			j: A3($terezka$line_charts$Internal$Axis$Ticks$ticks, system.aP, system.X, config.j),
			co: $terezka$line_charts$Internal$Axis$Title$config(config.co)
		};
		var viewAxisLine = A2($terezka$line_charts$Internal$Axis$viewVerticalAxisLine, system, viewConfig.b4);
		var at = function (y) {
			return {W: viewConfig.b4, X: y};
		};
		var viewTick = function (tick) {
			return A3(
...
var $terezka$line_charts$LineChart$viewCustom = F2(
	function (config, lines) {
		...
		var getJunk = A3(
			...
			$terezka$line_charts$Internal$Axis$variable(config.W),
		...
		var viewLines = $terezka$line_charts$Internal$Line$view(
			{bL: config.bL, aY: config.bU, b3: config.b3, bd: config.cb, bB: system});
		var viewLegends = $terezka$line_charts$Internal$Legends$view(
			{
				...
				ao: lines,
				bB: system,
				W: $terezka$line_charts$Internal$Axis$variable(config.W),
		...
		var attributes = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					config.bS),
					A3($terezka$line_charts$Internal$Events$toContainerAttributes, dataAll, system, config.bX),
					_List_fromArray(
					[
		...
		var addGrid = $terezka$line_charts$Internal$Junk$addBelow(
			A4($terezka$line_charts$Internal$Grid$view, system, config.W, config.X, config.bZ));
		var junk = addGrid(
			A2(getJunk, system, config.b9));
		return A4(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A3($terezka$line_charts$Internal$Axis$viewHorizontal, system, config.b4, config.W),
						A3($terezka$line_charts$Internal$Axis$viewVertical, system, config.b4, config.X),
						viewLegends,
						A2(
						$elm$svg$Svg$g,
						_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		$author$project$Main$chartConfig,
		A2($elm$core$List$map, $author$project$Main$lineCharts, model.x));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{b2: $author$project$Main$init, cm: $author$project$Main$subscriptions, cu: $author$project$Main$update, cw: $author$project$Main$view});
